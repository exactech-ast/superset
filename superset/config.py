...
from flask import Blueprint, redirect, g, redirect, request
...
from superset import app as flask_app
...
class MyUserDBModelView(UserDBModelView):
    ...
    def login(self):
        ...
        original_response = super().login()
        # If login is successful, redirect to the dashboards list page
        if original_response.location == '/superset/welcome/':
            original_response.location = '/dashboard/list'
        return original_response

class CustomSecurityManager(SupersetSecurityManager):
    auth_view = MyUserDBModelView

# Assign the custom security manager to the config
...
APP_NAME = "Exactech Datamesh"

# Specify the App icon
APP_ICON = "/static/assets/images/exactech_logo_white.png"
